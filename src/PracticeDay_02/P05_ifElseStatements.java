...
public class P05_ifElseStatements {
    public static void main(String[] args) {
       ...
       *** String icin equals method’unusalı kullanin
        */
        ...
        if (gunAdi.equals("pazartesi") || gunAdi.equals("salı") || gunAdi.equals("çarşamba") ||
                gunAdi.equals("perşembe") || gunAdi.equals("cuma")) {
            System.out.println("Bugünü -"+ gunAdi+ "- olarak  girdiniz");
            System.out.println("Bugün Hafta içi");
        }
        if (!(gunAdi.equals("pazartesi") || gunAdi.equals("salı") || gunAdi.equals("çarşamba") ||
                gunAdi.equals("perşembe") || gunAdi.equals("cuma") || gunAdi.equals("cumartesi") || gunAdi.equals("pazar"))) {
   ...
   2- Kullanıcıdan İki adet vize notu ve bir adet final notu girmesini isteyin
     ...
     */
        ...
        // "" nin içinde bırakılan boşlugu görüyor onun dışında boşlugu görmüyor.
        // yani bu örnekte soyadınız:    SARİ yazmıyor.
